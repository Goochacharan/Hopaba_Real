...
const ListingActionButtons: React.FC<ListingActionButtonsProps> = ({
  ...
  return <div className="flex justify-between items-center gap-2 mt-4">
      <button onClick={handleCall} className="flex-1 h-12 rounded-full bg-[#1EAEDB] text-white hover:bg-[#1EAEDB]/90 transition-all flex items-center justify-center shadow-[0_5px_0px_0px_rgba(24,128,163,0.8)] hover:shadow-[0_3px_0px_0px_rgba(24,128,163,0.8)] active:shadow-none active:translate-y-[3px]" title="Call Seller" aria-label="Call seller">
