...
const InspectionCertificatesCard: React.FC<InspectionCertificatesCardProps> = ({ certificates }) => {
    ...
    <>
      <Card className="bg-white shadow-sm border rounded-xl overflow-hidden mt-4">
        <CardHeader className="pb-3">
          <CardTitle className="font-semibold text-sm flex items-center">
          ...
          <div className="flex flex-wrap gap-2">
            {certificates.map((cert, index) => (
              <Button 
                ...
                size="sm" 
                variant="outline" 
                className="text-xs px-3 py-1 h-auto border border-blue-200 hover:border-blue-500 hover:bg-blue-50"
