    ...
    <div className={cn("relative group", className)}>
      <AspectRatio ratio={4/3} className="bg-muted">
        ...
        <Button
          ...
          variant="secondary"
          className={cn(
            "absolute top-2 right-2 z-10 opacity-90 shadow-md",
            isInWishlistAlready ? "bg-primary text-primary-foreground hover:bg-primary/90" : "bg-background text-foreground"
          )}
        ...
        {imageArray.length > 1 && (
          <>
            <Button
              size="icon"
              variant="ghost"
              className="absolute left-2 top-1/2 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-background/50 hover:bg-background/70"
            ...
            <Button
              size="icon"
              variant="ghost"
              className="absolute right-2 top-1/2 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-background/50 hover:bg-background/70"
