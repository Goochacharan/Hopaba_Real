...
const MarketplaceListingCard: React.FC<MarketplaceListingCardProps> = ({
  ...
  return (
    <div 
      ...
      className={cn(
        "group bg-white rounded-xl border border-border/50 overflow-hidden transition-all cursor-pointer relative", 
        "hover:shadow-lg hover:border-primary/20 hover:scale-[1.01]", 
        className
      )}
    >
      <NewBadge createdAt={listing.created_at} />
      ...
      <div className="p-4 px-[12px] py-[8px]">
        ...
        <div className="flex justify-between items-start mb-4 py-0 my-0">
          <div className="flex items-center gap-2">
            <p className="text-2xl font-bold text-[#1EAEDB] py-[12px]">
