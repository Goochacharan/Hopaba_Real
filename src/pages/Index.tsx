...
const Index = () => {
  ...
  const recentSearches = ["Good salon for haircut", "Pizza delivery near me", "Plumber in Nagarbhavi"];

  // Sample trending searches
  const trendingSearches = ["Hidden gem restaurants in Indiranagar", "Best veg restaurants open now", "Top-rated salons with offers"];
  ...
  return <MainLayout>
      <section className="flex flex-col items-center justify-center py-8 md:py-14">
        ...
        {!showResults && <div className="w-full max-w-2xl mx-auto mt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                {recentSearches.map((search, idx) => <Button key={idx} variant="ghost" className="w-full justify-start text-left text-muted-foreground hover:text-foreground" onClick={() => handleSearch(search)}>
              ...
              <div className="space-y-4">
                ...
                {trendingSearches.map((search, idx) => <Button key={idx} variant="ghost" className="w-full justify-start text-left text-muted-foreground hover:text-foreground" onClick={() => handleSearch(search)}>
